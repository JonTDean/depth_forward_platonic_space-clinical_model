...
# Philosopher Bundle - Representation, Meaning, and Decision
**Date:** 2025-11-15

## Questions
- What makes two ontology nodes the "same concept" when vectors differ?
- Are geometry-based thresholds epistemic or pragmatic?
- How do graph commitments (Leiden partitions) shape taxonomic realism.
...
graph LR
  ...
  ConceptA[Concept A] --> Meaning
  ConceptA --> Use
  ConceptB[Concept B] --> Meaning
  Meaning --> Truth
  Use --> Truth
```
